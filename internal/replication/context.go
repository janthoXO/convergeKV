// Package replication implements the anti-entropy replication protocol for ConvergeKV.
// It provides a CausalContext for tracking per-peer high watermarks, a gRPC handler
// for inbound sync requests, and an anti-entropy loop that pushes/pulls deltas.
package replication
