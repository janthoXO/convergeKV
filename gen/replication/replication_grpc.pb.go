...
const (
	SyncService_GetIBLT_FullMethodName     = "/replication.SyncService/GetIBLT"
...
func (c *syncServiceClient) GetIBLT(ctx context.Context, in *GetIBLTRequest, opts ...grpc.CallOption) (*GetIBLTResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetIBLTResponse)
	err := c.cc.Invoke(ctx, SyncService_GetIBLT_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SyncService_GetIBLT_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetIBLTRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SyncServiceServer).GetIBLT(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SyncService_GetIBLT_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SyncServiceServer).GetIBLT(ctx, req.(*GetIBLTRequest))
	}
...
var SyncService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetIBLT",
			Handler:    _SyncService_GetIBLT_Handler,
		},
	},
